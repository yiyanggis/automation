...
#select cbsa polygon
CBSACode=arcpy.GetParameterAsText(0)
FiberRouteLayer=arcpy.GetparamaterAsText(1)
StreetLayer=arcpy.GetparamaterAsText(2)
CBSABoundaryLayer=arcpy.GetparamaterAsText(3)
...
FiberRoutes_shp=FiberRouteLayer
...
CBSA_Boundaries=CBSABoundaryLayer
